...
Usage:
    python Project/run_mlops_complete.py [--skip-tests] [--skip-drift]
...
def step_1_environment_validation() -> bool:
    ...
    validate_script = project_root / "Project" / "validate_environment.py"
...
def step_3_training_pipeline() -> bool:
    ...
    pipeline_script = project_root / "Project" / "run_full_pipeline.py"
...
def step_5_data_drift_monitoring(skip: bool = False) -> bool:
    ...
    drift_script = project_root / "Project" / "monitor_data_drift_evidently.py"
